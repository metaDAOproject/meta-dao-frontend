        ...
        <Fieldset legend="Mint Conditional Tokens" miw="350px" w="100%" pos="relative">
            <HoverCard position="top">
                ...
                <HoverCard.Dropdown w="22rem">
                    <Stack>
                        <Text>
                            Conditional tokens are the tokens used to trade on conditional markets.
                            You can mint some by depositing $META or $USDC. These tokens will be
                            locked up until the proposal is finalized.
                        </Text>
                        <Text size="sm">
                            <Text span fw="bold">
                                Pass tokens (pTokens){' '}
            ...
            >
                Mint{' '}
                {mintAmount
                    ? `${mintAmount} p${token.symbol} and ${mintAmount} f${token.symbol}`
                    : ''}
            </Button>
        </Fieldset>
    );
